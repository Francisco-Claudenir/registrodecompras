...
<body>
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{!! url('/tema/index'); !!}" class="brand-logo">
                <img src="/images/uema/svg/icon_uema.svg" class="img-fluid" width="50" height="50" alt="">
                ...
                <svg class="brand-title" viewBox="0 0 105 22" width="90" height="22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <text class="svg-logo-path" x="0" y="15" fill="black" font-weight="bold">Dashboard</text>
        ...
        ***********************************-->
		...
		@include('tema.zenix.elements.header')
        ...
        ***********************************-->
        ...
        <!--**********************************
            Sidebar start
        ***********************************-->
        @include('tema.zenix.elements.sidebar')
        <!--**********************************
            Sidebar end
        ***********************************-->
        ...
        ***********************************-->
		...
		@include('tema.zenix.elements.footer')
    ...
    ***********************************-->
    ...
    <!--**********************************
        Scripts
    ***********************************-->
	@include('tema.zenix.elements.footer-scripts')
    @yield('scripts')
</body>
</html>