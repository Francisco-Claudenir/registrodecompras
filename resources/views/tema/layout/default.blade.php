...
<head>
    ...
    <link rel="icon" type="image/svg" sizes="16x16" href="{{ config('temauema.favIcon') }}">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{ route(config('temauema.homePage')) }}" class="brand-logo">
                <img src="{{ config('temauema.brandIcon') }}" class="img-fluid" width="{{ config('temauema.brandIconWidth') }}" height="{{ config('temauema.brandIconHeight') }}" alt="">
                ...
                <svg class="brand-title" viewBox="0 0 105 22" width="90" height="22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <text class="svg-logo-path" x="0" y="15" fill="black">{{ config('temauema.systemName') }}</text>
