...
<head>
    ...
    <meta property="og:description" content="{{ config('temauema.PageTitle') }} | @yield('title', $page_title ?? '')" />
    ...
    <link rel="icon" type="image/svg" sizes="16x16" href="{{ config('temauema.system.favIcon') }}">
...
<body>
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{ route(config('temauema.routes.home')) }}" class="brand-logo">
                <img src="{{ config('temauema.system.brand.icon') }}" class="img-fluid" width="{{ config('temauema.system.brand.iconWidth') }}" height="{{ config('temauema.system.brand.iconHeight') }}" alt="">
                ...
                <svg class="brand-title" viewBox="0 0 105 22" width="90" height="22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <text class="svg-logo-path" x="0" y="15" fill="black">{{ config('temauema.system.name.name') }}</text>
                    Sorry, your browser does not support inline SVG.
                </svg>
            </a>

            @if (config('temauema.layouts.default.hasSideBar') == false)
        ...
        ***********************************-->
        ...
        <!--**********************************
            Content body start
        ***********************************-->
        @if (config('temauema.layouts.default.hasSideBar') == true)
    ...
    ***********************************-->
    ...
    <!--**********************************
        Scripts
    ***********************************-->
    @include('tema.elements.footer-scripts')
    @yield('scripts')
</body>
