...
<head>
    ...
    <link rel="icon" type="image/svg" sizes="16x16" href="{{ config('temauema.PageIcon') }}">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{ route(config('temauema.HomePage')) }}" class="brand-logo">
                <img src="{{ config('temauema.DashboardIcon') }}" class="img-fluid" width="{{ config('temauema.DashboardIconWidth') }}" height="{{ config('temauema.DashboardIconHeight') }}" alt="">
                ...
                <svg class="brand-title" viewBox="0 0 105 22" width="90" height="22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <text class="svg-logo-path" x="0" y="15" fill="black">{{ config('temauema.DashboardTitle') }}</text>
