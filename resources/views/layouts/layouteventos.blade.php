...
@section('title', ' - @yield('page_title')')
                                ...
                                <div class="card-body">
                                    <div class="profile-statistics">
                                        <div class="text-center">
                                            <div class="row">
                                                <div class="col">
                                                    <h3 class="m-b-0">26/05/2023</h3><span>Data início</span>
                                                </div>
                                                <div class="col">
                                                    <h3 class="m-b-0">26/05/2023</h3><span>Data fim</span>
                                                </div>
                                    ...
                                    <div class="tab-content">
                                        <div id="my-posts" class="tab-pane fade">
                                            <div class="my-post-content pt-3">
                                                ...
                                                <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                    <img src="https://zenix.dexignzone.com/laravel/demo/images/profile/9.jpg"
                                                        alt="" class="img-fluid w-100 rounded">
                                                    <a class="post-title"
                                                        href="https://zenix.dexignzone.com/laravel/demo/post-details">
                                                        <h3 class="text-black">Collection of textile samples lay spread
                                                    ...
                                                    <form>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="mb-3 col-md-4">
                                                                ...
                                                                <div
                                                                    class="dropdown bootstrap-select form-control default-select wide">
                                                                    <select class="form-control default-select wide"
                                                                        ...
                                                                        aria-expanded="false" title="Choose..."
                                                                        data-id="inputState">
