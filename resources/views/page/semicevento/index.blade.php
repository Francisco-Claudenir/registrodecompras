                            ...
                            <div class="col-lg-2">
                                <div class="email-left-box generic-width px-0 mb-5">
                                    <div class="mail-list rounded mt-4">
                                        <a class="list-group-item active"><i
                                                class="fa fa-inbox font-18 align-middle me-2"></i>Filtro</a>
                                        <a href="{{ route('semic.eventoinscricao.index',['semic_evento_id' => $semic_evento->semic_evento_id, 'tipo' => 'Todos'])}}"
                                           class="list-group-item"><span class="icon-warning"><i class="fa fa-circle"
                                                                                                 aria-hidden="true"></i></span>
                                            Todos </a>
                                        <a href="{{ route('semic.eventoinscricao.index',['semic_evento_id' => $semic_evento->semic_evento_id, 'tipo' => 'Ouvinte'])}}"
                                           class="list-group-item"><span class="icon-warning"><i class="fa fa-circle"
                                                                                                 aria-hidden="true"></i></span>
                                            Ouvinte </a>
                                        <a href="{{ route('semic.eventoinscricao.index',['semic_evento_id' => $semic_evento->semic_evento_id, 'tipo' => 'Apresentador'])}}"
                                           class="list-group-item"><span class="icon-warning"><i class="fa fa-circle"
                                                                                                 aria-hidden="true"></i></span>
                                            Apresentador </a>
                                                ...
                                                <div class="basic-dropdown">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a href="{{ route('lista.inscritos.semicevento',['semic_evento_id' => $semic_evento->semic_evento_id, 'tipo' => 'Todos']) }}"
                                                               class="dropdown-item">Todos</a>
                                                            <a href="{{ route('lista.inscritos.semicevento',['semic_evento_id' => $semic_evento->semic_evento_id, 'tipo' => 'Ouvinte']) }}"
                                                               class="dropdown-item">Ouvinte</a>
                                                            <a href="{{ route('lista.inscritos.semicevento',['semic_evento_id' => $semic_evento->semic_evento_id, 'tipo' => 'Apresentador']) }}"
                                                               class="dropdown-item">Apresentador</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                                ...
                                                                <td>
                                                                    <a href="{{  route('semic.eventoinscricao.espelho', ['semic_evento_id' => $dados->semic_evento_id, 'semic_eventoinscricao_id' => $dados->semic_eventoinscricao_id]) }}"
                                                                       class="badge badge-circle badge-dark"><i
                                                                            class="flaticon-381-file-2"></i></a>
                                                                    <a href="{{  route('semic.eventoinscricao.destroy', ['semic_eventoinscricao_id' => $dados->semic_eventoinscricao_id]) }}"
                                                                       class="badge badge-circle badge-danger"><i
