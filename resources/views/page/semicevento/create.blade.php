                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8 col-md-12 col-sm-12">
                            ...
                            <div class="basic-form">
                                <div class="mb-3 mb-0">
                                    <label class="radio-inline me-3"><input type="radio" required id="sim_radio_ouvinte"
                                                                            name="radio_ouvinte" value="1"> Sim</label>
                                    <label class="radio-inline me-3"><input type="radio" required id="nao_radio_ouvinte"
                                                                            name="radio_ouvinte" value="0"> Não</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-8 col-md-12 col-sm-12">
                            ...
                            <div class="basic-form">
                                <div class="mb-3 mb-0">
                                    <label class="radio-inline me-3"><input type="radio" required
                                                                            id="sim_radio_minicurso"
                                                                            name="radio_minicurso" value="1">
                                        Sim</label>
                                    <label class="radio-inline me-3"><input type="radio" required
                                                                            id="nao_radio_minicurso"
                                                                            name="radio_minicurso" value="0">
                                        Não</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-8 col-md-12 col-sm-12" id="pergunta_participante">
                            ...
                            <div class="basic-form">
                                <div class="mb-3 mb-0">
                                    <label class="radio-inline me-3"><input type="radio" required
                                                                            id="sim_radio_participante"
                                                                            name="radio_participante" value="1">
                                        Sim</label>
                                    <label class="radio-inline me-3"><input type="radio" required
                                                                            id="nao_radio_participante"
                                                                            name="radio_participante" value="0">
                                        Não</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-8 col-md-12 col-sm-12">
                            <div class="card border shadow-sm">
                                <div class="card-body">
                                    ...
                                    <button id="button_enviar" type="submit" class="btn btn-primary float-end">Enviar
                                    </button>
                                </div>
                            </div>
                        </div>
...
@section('scripts')
    <script>
        document.getElementById("sim_radio_minicurso").addEventListener("click", function () {
            ...
            @php
                $vagas = $minicurso->vagas*2;
            @endphp
            @if($vagas > count($minicurso->minicurso_semiceventoinscricao))
            <div class="col-3">
