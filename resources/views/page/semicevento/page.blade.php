                                ...
                                <div class="custom-tab-1">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li class="nav-item"><a href="#my-posts" data-bs-toggle="tab"
                                                                class="nav-link show">Minicursos</a>
                                        </li>
                                    </ul>
                                            ...
                                            <div class="my-post-content">
                                                <div class="pt-4 border-bottom-1 pb-4">
                                                    @foreach($semic_evento->semic_evento_minicursos as $minicurso)
                                                        ...
                                                        <div class="p-2">
                                                        <h4 class="text-primary">{{$minicurso->nome}}</h4>
                                                        <span class="badge badge-outline-info">{{$minicurso->vagas}} Vagas</span>
                                                        <span class="badge badge-outline-success">{{$minicurso->horas}}h - Carga Horária</span>
                                                            <br>
                                                            <span>{!!  $minicurso->descricao !!}
                                                                </span>
                                                        </div>
                                                    @endforeach
                                                </div>
