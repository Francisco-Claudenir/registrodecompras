                                    ...
                                    <div class="profile-statistics">
                                        <div class="text-center">
                                            <div class="row">
                                                <div class="col">
                                                    <h4 class="m-b-0">
                                                        {{ date('d/m/Y', strtotime($primeiropasso->data_inicio)) }}</h4>
                                                    <span>Data
                                                        início</span>
                                                </div>
                                                <div class="col">
                                                    <h4 class="m-b-0">
                                                        {{ date('d/m/Y', strtotime($primeiropasso->data_fim)) }}</h4>
                                                    <span>Data
                                                        fim</span>
                                                </div>
                                            ...
                                            <div class="row mt-4 justify-content-center">
                                                <a href="{{ route('primeirospassos.inscricao.create', $primeiropasso->primeiropasso_id) }}"
