                    ...
                    <div class="card project-card">
                        <div class="card-body">
                            <div class="d-flex mb-4 align-items-start">
                                ...
                                <a href="{{ route('semicevento.edit', $semic_evento->semic_evento_id) }}"><i class="fa fa-cog text-primary"
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <h6>Progress
                                        <span class="pull-right">{{ number_format($semic_evento->percentual(), 2) }}%</span>
                                    </h6>
                                    <div class="progress ">
                                        <div class="progress-bar bg-info progress-animated"
                                            style="width: {{ $semic_evento->percentual() }}%; height:6px;" role="progressbar">
                                        </div>
                                    </div>
                                </div>
                            </div>
