...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            @foreach ($programasSemic_evento as $semic_evento)
                <div class="col-xl-6 col-lg-12">
                    <div class="card project-card">
                        <div class="card-body">
                            <div class="d-flex mb-4 align-items-start">
                                <div class="dz-media me-3">
                                    <img src="{{ url('../storage/' . $semic_evento->banner)}}" class="img-fluid" alt="">
                                </div>
                                <div class="me-auto">
                                    <h4 class="title mb-2 mt-1">{{ $semic_evento->nome }}</h4>
                                ...
                                <a href="{{ route('semicevento.edit', $semic_evento->semic_evento_id) }}"><i
                            ...
                            <div class="row mb-4">
                                <div class="col-sm-6 mb-sm-0 mb-3 d-flex">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 pt-1 font-w500 text-black">
                                            {{ date('d/m/Y', strtotime($semic_evento->data_inicio)) }}</p>
                                    </div>
                                </div>
                                <div class="col-sm-6 d-flex">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 pt-1 font-w500 text-black">
                                            {{ date('d/m/Y', strtotime($semic_evento->data_fim)) }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-4">
                                <div class="col-sm-6 mb-sm-0 mb-3 d-flex align-items-baseline justify-content-between ">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div>Inscritos:<span class="text-black ms-3 font-w600"><a
                                                href="{{ route('semic.eventoinscricao.index',['semic_evento_id' => $semic_evento->semic_evento_id, 'tipo' => 'Todos'])}}">{{$semic_evento->semic_evento_semic_eventoinscricao_count }}</a></span>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <h6>Progress
                                        <span
                                            class="pull-right">{{ number_format($semic_evento->percentual(), 2) }}%</span>
                                    </h6>
                                    <div class="progress ">
                                        <div class="progress-bar bg-info progress-animated"
                                             style="width: {{ $semic_evento->percentual() }}%; height:6px;"
                                             role="progressbar">
                                        </div>
                                    </div>
                                </div>
