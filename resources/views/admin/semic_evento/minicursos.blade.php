                                                    ...
                                                    <div class="col-3">
                                                        <div
                                                            ...
                                                            <strong
                                                                ...
                                                                Hora</strong>
                                                            {{ date('d/m/Y', strtotime($cursos->data_hora)) }}
                                                            - {{date('H:m' , strtotime($cursos->data_hora))}}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-xl-6 col-xxl-6 col-md-6">
                                                                    <label class="form-label">Data e Hora</label>
                                                                    <input type="text" id="date-format1"
                                                                           name="data_hora"
                                                                           class="form-control" placeholder="{{now()}}"
                                                                           value="{{$cursos->data_hora}}">
                                                                </div>
                                                                <div class="row mt-4">
                                                                    <h5 class="form-label">Descrição</h5>
                                                                    <div class="col-xl-12 col-xxl-12">
                                            ...
                                            <div class="project-info">
                                                ...
                                                <div class="col-xl-4 my-2 col-lg-6 col-sm-6 ">
                                                    <div class="text-dark mt-4"><strong>Inscritos
                                                            : </strong>
                                                        <a href="{{route('listaminicurso.semicevento',['semic_evento_id' => $semic_evento->semic_evento_id, 'minicurso_id' => $cursos->minicurso_id])}}">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                <a class="dropdown-item"
                                                                   ...
                                                                   data-bs-target="#editminicursomodal-{{$cursos->minicurso_id}}"
                                                                   onclick="definirData(cursos)">Editar</a>
                                                                <a class="dropdown-item"
