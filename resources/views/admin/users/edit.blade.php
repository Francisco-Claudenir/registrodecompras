                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="nome"
                                                ...
                                                value="{{ $user->nome }}" placeholder="Nome" required autocomplete="Nome"
                                                autofocus>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="cpf"
                                                ...
                                                value="{{ $user->cpf }}" placeholder="Ex : 00000000000" required
                                                autocomplete="cpf" autofocus maxlength="11" readonly disabled>
                                            <div class="input-group-text">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="telefone"
                                                ...
                                                value="{{ $user->telefone }}" placeholder="00 00000-00000" required
                                                autocomplete="phone">
                                            <div class="input-group-text">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="endereco[cep]" id="cep"
                                                ...
                                                placeholder="0000000" required value="{{ $endereco['cep'] }}" maxlength="9"
                                                pattern="/^[0-9]{5}\-[0-9]{3}$/">
                                            {{-- <div class="input-group-text"> --}}
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="input-group">
                                            <select
                                                class="default-select form-control form-custom @error('perfil_id') is-invalid @enderror wide mb-3"
                                                ...
                                                @foreach ($perfis as $perfil)
                                                    <option value="{{ $perfil->id }}"
                                                        @if (($user->perfil_id ?? $perfil->id) == $user->perfil_id) selected @endif>
                                                        {{ $perfil->nome }}</option>
                                                @endforeach
                                            </select>
                                        </div>
