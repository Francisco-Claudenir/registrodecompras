                ...
                <div class="tab-pane fade active show" id="navpills-1">
                    ...
                    <div class="card">
                        <div class="project-info">
                            <div class="col-xl-3 my-2 col-lg-4 col-sm-6">
                                ...
                                <h5 class="title font-w600 mb-2"><a href="https://zenix.dexignzone.com/laravel/demo/post-details" class="text-black">Reduce Website Page Size Omah</a></h5>
                    ...
                    <div class="card">
                        <div class="project-info">
                            <div class="col-xl-3 my-2 col-lg-4 col-sm-6">
                                <p class="text-primary mb-1">#P-000441425</p>
                                <h5 class="title font-w600 mb-2"><a href="https://zenix.dexignzone.com/laravel/demo/post-details" class="text-black">Build Branding Persona for Etza.id</a></h5>
                                <div class="text-dark"><i class="far fa-calendar me-3" aria-hidden="true"></i>Created on Sep 8th, 2020</div>
                            </div>
                            <div class="col-xl-2 my-2 col-lg-4 col-sm-6">
                                <div class="d-flex align-items-center">
                    ...
                    <div class="card">
                        <div class="project-info">
                            <div class="col-xl-3 my-2 col-lg-4 col-sm-6">
                                <p class="text-primary mb-1">#P-000441425</p>
                                <h5 class="title font-w600 mb-2"><a href="https://zenix.dexignzone.com/laravel/demo/post-details" class="text-black">Manage SEO for Eclan Company P..</a></h5>
                                <div class="text-dark"><i class="far fa-calendar me-3" aria-hidden="true"></i>Created on Sep 8th, 2020</div>
                            </div>
                            <div class="col-xl-2 my-2 col-lg-4 col-sm-6">
                                <div class="d-flex align-items-center">
