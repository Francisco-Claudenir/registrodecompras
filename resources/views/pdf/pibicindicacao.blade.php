...
<div class="col-sm-12 text-center">
    ...
    <small>
        <strong style="text-transform: uppercase">
            {{ $indicacao_bolsista->nome }}
        </strong>
    </small> <br>
    <small>
        <strong>
            Data Inicio: {{ date('d/m/Y', strtotime($indicacao_bolsista->data_inicio)) }} / Data Fim:
            {{ date('d/m/Y', strtotime($indicacao_bolsista->data_fim)) }}
        </strong>
    </small> <br>
    <small>
        <strong>
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <th>
                        ...
                        <small>
                            <dd>
                                <p style="font-size: 14px">{{ $dadosInscrito->tituloprojeto_orientador }}</p>
                            </dd>
                        </small>
                    </th>
                    <td colspan="2">
                        ...
                        <small>
                            <dd>
                                <p style="font-size: 14px">{{ $dadosInscrito->tituloplano_bolsista }}</p>
                            </dd>
                        </small>
                    </td>
                    @if ($indicacao_bolsista->tipo == 'Cnpq')
                        <td colspan="2">
                            <strong>
                                <h6>
                                    <dt style="font-size: 14px">Link do Currículo Lattes do Orientador(a)</dt>
                                </h6>
                            </strong>
                            <small>
                                <dd>
                                    <p style="font-size: 14px">{{ $dadosInscrito->curriculolattes_orientador }}</p>
                                </dd>
                            </small>
                        </td>
                    @endif
                    @if ($indicacao_bolsista->tipo == 'Cnpq' || $indicacao_bolsista->tipo == 'Ações Afirmativas')
                        <td colspan="2">
                            <strong>
                                <h6>
                                    <dt style="font-size: 14px">3 Palavras chave</dt>
                                </h6>
                            </strong>
                            <small>
                                <dd>
                                    <p style="font-size: 14px">{{ $dadosInscrito->palavras_chave }}</p>
                                </dd>
                            </small>
                        </td>
                    @endif
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <th>
                        ...
                        <small>
                            <dd class="text-justify"><a style="color: red;"
                                                        href="{{ route('pp-i-bolsistas-inscricao.docshow', ['diretorio' => Crypt::encrypt($dadosInscrito->termocompromisso_bolsista)]) }}">Arquivo</a>
                                </p>
                            </dd>
                        </small>
                    </th>
                ...
                <tr>
                    <th>
                        ...
                        <small>
                            <dd class="text-justify"><a style="color: red;"
                                                        href="{{ route('pp-i-bolsistas-inscricao.docshow', ['diretorio' => Crypt::encrypt($dadosInscrito->curriculo_lattes)]) }}">Arquivo</a>
                                </p>
                            </dd>
                        </small>
                    </th>
                        ...
                        <th>
                            ...
                            <small>
                                @if ($dadosInscrito->declaracao_estagio != null)
                                    <dd class="text-justify"><a style="color: red;"
                                                                href="{{ route('pp-i-bolsistas-inscricao.docshow', ['diretorio' => Crypt::encrypt($dadosInscrito->declaracao_estagio)]) }}">Arquivo</a>
                                        </p>
                                    </dd>
                                @else
                                    Sem Arquivo
                    ...
                    @if ($indicacao_bolsista->tipo == 'Ações Afirmativas')
                        <th>
                            <strong>
                                <h6>
                                    <dt style="font-size: 14px">Documento comprobatório de ingresso UEMA por meio de ações
                                        afirmativas</dt>
                                </h6>
                            </strong>
                            <small>
                                @if ($dadosInscrito->doc_comprobatorio != null)
                                    <dd class="text-justify"><a style="color: red;"
                                                                href="{{ route('pp-i-bolsistas-inscricao.docshow', ['diretorio' => Crypt::encrypt($dadosInscrito->doc_comprobatorio)]) }}">Arquivo</a>
                                        </p>
                                    </dd>
                                @else
                                    Sem Arquivo
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <th>
                        ...
                        <small>
                            <dd class="text-justify"><a style="color: red;"
                                                        href="{{ route('pp-i-bolsistas-inscricao.docshow', ['diretorio' => Crypt::encrypt($dadosInscrito->termocompromisso_orientador)]) }}">Arquivo</a>
                                </p>
                            </dd>
                        </small>
                    </th>
